...
export default function Hero() {
    return <section className="hero mt-8">
        <div className="py-12">
            ...
            <p className="my-4 text-gray-500 text-sm">Pizza is the missing piece that makes every day complete, a simple yet deliceous job in life.</p>
        ...
        <div className="relative">
            <Image src={'/pizza.png'} alt="pizza_img" layout={'fill'} objectFit={'contain'} />
        </div>
    </section>
}